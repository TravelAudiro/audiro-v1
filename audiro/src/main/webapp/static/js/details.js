	...
	return data.map(cmm => {
		...
		return `
									<div class="mt-2" style="display: flex; align-items: flex-start; margin-left: ${level * 50}px;">
									    <img src="${cmm.path}" alt="프로필 이미지" class="p-profile-image" id="p-profile-image" style="margin-right: 10px; margin-left: 50px;">
									    <div style="flex: 1;">
									        ...
									        <div class="custom-label" style="max-height: 100px; overflow-y: auto; padding: 5px; margin-bottom: 5px; display: flex; align-items: center; justify-content: space-between; border: none;"> <!-- 테두리 제거 -->
									            ...
									            <div class="edit-icons" style="display: flex; align-items: center;">
									                ...
									                <button onClick="activeReply(${cmm.commentsId})" class="btn btn-outline-warning rounded-pill reply-btn" data-comments-id="${cmm.commentsId}" style="font-size: 0.8em; margin-left: 10px;">
									                    댓글 추가
									                </button>
									            </div>
									        </div>
