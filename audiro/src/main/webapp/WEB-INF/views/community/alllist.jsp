            ...
            <div class="col-md-4 col-lg-3 mb-3">
                <div class="card mb-3">
                    <h3 class="card-header"
                        style="background-color: #E5FF81; text-align: center;">AUDIRO💛COMMUNITY</h3>
                    <div class="card-body">
                        <h5 class="card-title m-1"
                            style="text-align: center;">Entire Board</h5>
                        <h6 class="card-subtitle text-muted p-2"
                            style="text-align: center;">You can see the entire posts</h6>
                        <img
                            style="display: block; margin: 0 auto; width: 100%;"
                            src="../images/alllogo.png" alt="전체게시판">
                    </div>
                    <div class="card-body">
                        <p class="ps-3 pe-3" style="text-align: center;">"여행 어디로 가지? 어디로!"</p>
                    </div>
                ...
                <main>
                    <div class="card border-light mb-3">
                        <div class="card-header">
                            <p class="mt-3 ms-2">
                                🍋<span class="text-body-secondary"> 전체 목록</span>
                            </p>
                            <!-- 글 타입 끝 -->
                        </div>
                        <!-- 글목록 테이블 시작 -->
